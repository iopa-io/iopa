...
function initIopaNativeContextPrototype(contextPrototype){
    ...
    contextPrototype.protoype["iopa.WriteHead"] = function iopa_WriteHead(statusCode, headers)
    {
    ...
    contextPrototype.protoype["iopa.SetHeader"] = function iopa_SetHeader(key, val)
    {
        private_setIgnoreCase(this["iopa.Headers"], key, val);
    }
    
    contextPrototype.protoype["iopa.GetHeader"] = function iopa_GetHeader(key)
    {
        return private_getIgnoreCase(this["iopa.Headers"], key);
    }
    
    contextPrototype.protoype["iopa.RemoveHeader"] = function iopa_RemoveHeader(key, value)
    {
