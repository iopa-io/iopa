...
var counter =
    ...
    IopaContext.prototype.init = function IopaContext_init() {
        ...
        //  console.log(context["iopa.Seq"] + " created");
...
IopaContextFactory._create = function (withoutResponse) {
...
/**
 * Creates a default IOPA Request / Response
 *
...
IopaContextFactory.createContext = function IopaContextFactory_createContext() {
    var context = IopaContextFactory._create();
...
IopaContextFactory.createRequest = function IopaContextFactory_createRequest(urlStr, method) {
    ...
    var context = IopaContextFactory._create(true);
